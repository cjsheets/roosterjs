...
export default class ContentTraverser {
     ...
     */
    private constructor(private scoper: TraversingScoper, private atomTags?: string[]) {}
    ...
    public static createSelectionTraverser(
        ...
        const scoper = isRange(rangeOrStart)
            ...
            : new SelectionScoper(rootNode, rangeOrStart, end);
        return new ContentTraverser(scoper, atomTags);
    }
